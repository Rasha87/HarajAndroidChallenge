...
class MainAdapter(
   private val harajDataList: ArrayList<HarajData> ,
    val onClickAdapterItem: OnClickAdapterItem
     ...
     class DataViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)
     {
        ...
        fun bind(harajData: HarajData, position: Int)
        {
            ...
            val date = DateManger.getTime(harajData.date!!)
            ...
            itemView.txtViewCommentCount.text = String.format(itemView.context.getString(R.string.comment),harajData.commentCount)
    ...
    {
        holder.bind(harajDataList[position],position)
       holder.itemView.setOnClickListener { onClickAdapterItem.onItemClick(harajDataList[position]) }
    }
